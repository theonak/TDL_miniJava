...
/*a function or attribute mplementation */
...
public class Definition implements Declaration {
    ...
    public Definition(Methode methode) {
    	this.methode= methode;
    }
    public Definition(Attribut attr) {
    	this.attribut= attr;
    }
    
 

    public  Definition(Constructor constructor){
    ...
    public boolean resolve(HierarchicalScope<Declaration> _scope,  List<MethodeSignature> methodeSignatureList,
        ...
        if(this.attribut != null ){
            ...
            return  this.attribut.resolve(_scope);
        }
        if(this.methode != null ) {
            ...
            if (methodeSignatureList.size() == 0) {
                methodeSignatureList.add(methode.getEntete());{
                    ...
                    return this.methode.resolve(_scope);
                ...
                for (MethodeSignature m : methodeSignatureList) {
                    ...
                    if (m.getName().equals(methode.getEntete().getName())) {
                        if (!m.getType().equals(methode.getEntete().getType())) {
                            methodeSignatureList.add(methode.getEntete());
                            return result = this.methode.resolve(_scope);
                        } else {
...
//								System.out.println(methodeSignatureList);
        ...
        if(this.constructor != null ) {
            ...
            if (constructorList.size() == 0) {
                ...
                return result = this.constructor.resolve(_scope);
	...
	public boolean collect(HierarchicalScope<Declaration> _scope) {
		if (this.attribut != null) {
			return this.attribut .collect(_scope);
		}
		else if (this.constructor != null) {
			return this.constructor .collect(_scope);
		}else  {
			return this.methode .collect(_scope);
		}
